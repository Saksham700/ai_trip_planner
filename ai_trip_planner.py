...
BASE_DIR = "/home/saksham/ai_trip_planner/"
os.makedirs(BASE_DIR, exist_ok=True)
os.makedirs(os.path.join(BASE_DIR, "room_data"), exist_ok=True)
...
ROOMS_FILE = os.path.join(BASE_DIR, "rooms.csv")
    ...
    try:
        ...
        if os.path.exists(ROOMS_FILE):
            ...
            for _, row in df.iterrows():
                ...
                # Load room data from pickle
                room_data_path = os.path.join(BASE_DIR, "room_data", f"{room_id}_data.pkl")
...
def save_rooms(rooms):
    try:
        ...
        for room_id, room_data in rooms.items():
            ...
            room_data_path = os.path.join(BASE_DIR, "room_data", f"{room_id}_data.pkl")
            with open(room_data_path, 'wb') as f:
